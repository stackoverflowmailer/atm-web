com.dj.project.developer.AllocationGridPanel = Ext.extend(Ext.grid.GridPanel, {
    url           : 'allocations/listAllAllocationsForMonth',
    ...
    initComponent : function() {
        ...
        com.dj.project.developer.AllocationGridPanel.superclass.initComponent.call(this);
    },
    buildStore : function() {
        return  {
            xtype    : 'jsonstore',
...
Ext.reg('allocationgridpanel', com.dj.project.developer.AllocationGridPanel);