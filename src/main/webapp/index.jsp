...
<head>
    ...
    <script type="text/javascript" src="extjs311/adapter/ext/ext-base-debug.js"></script>

    <!-- ...then you need the Ext itself, either debug or production version. -->
    <script type="text/javascript" src="extjs311/ext-all-debug.js"></script>
    ...
    <script type="text/javascript">
     ...
     Ext.BLANK_IMAGE_URL = 'extjs311/resources/images/default/s.gif';
