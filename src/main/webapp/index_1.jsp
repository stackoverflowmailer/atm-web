<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/enhanced-login.css">
        ...
        <script type="text/javascript" src="js/login/WindowTitleComponent.js"></script>
        <script type="text/javascript" src="js/login/EnhancedLogin.js"></script>
        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function(){
               new com.dj.project.login.EnhancedLoginWindow().show(); 
            });
